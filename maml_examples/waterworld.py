...
class WaterWorld(AbstractMAEnv, EzPickle):
    ...
    def __init__(self, radius=0.015, obstacle_radius=0.2, obstacle_loc=np.array([0.5, 0.5]),
        ...
        EzPickle.__init__(self, radius, obstacle_radius, obstacle_loc,
                        ...
                        speed_features, is_observability_full, max_velocity_pursuer, **kwargs)
    ...
    def sample_goals(self, num_goals):
        return np.random.uniform(0.1, 0.6, size=(num_goals, 1, ))
        
    @property
    def observation_space(self):
        return spaces.Box(low=-10, high=10, shape=(self._pursuer._obs_dim,))
    ...
    def step(self, action):
        ...
        # print(rlist)
        return Step(observation=obslist, reward=reward, done=done, goal=self.evader_params[0])
